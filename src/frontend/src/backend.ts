...
export class Backend implements backendInterface {
    ...
    async addStudent(arg0: string, arg1: string, arg2: string): Promise<void> {
    ...
    async getAllStudentsSortedByEmail(): Promise<Array<Student>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStudentsSortedByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStudent(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
